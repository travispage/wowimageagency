(function ($) {
	...
	$(document).ready(function() {
		...
		var windowWidth, windowHeight, documentHeight, offsetTop, scrollTop, containerHeight, containerOffset, $window = $(window);
		...
		$window.bind('scroll', function(e) {
			...
			if (page_num <= max_pages && !$popup.hasClass('visible') && scrollTop < documentHeight && scrollTop > (containerHeight + containerOffset - windowHeight * .5) && !$popup.hasClass('last-page')) {
				$.ajax({
					type: 'GET',
					url: next_link,
					dataType: 'html',
